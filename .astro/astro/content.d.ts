...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"articles": {
"bankrotstvo-kak-sistema.md": {
	id: "bankrotstvo-kak-sistema.md";
  slug: "bankrotstvo-kak-sistema";
  body: string;
  collection: "articles";
  data: InferEntrySchema<"articles">
} & { render(): Render[".md"] };
"mediinyi-landshaft.md": {
	id: "mediinyi-landshaft.md";
  slug: "mediinyi-landshaft";
  body: string;
  collection: "articles";
  data: InferEntrySchema<"articles">
} & { render(): Render[".md"] };
...
"articlesUk": Record<string, {
  id: string;
  slug: string;
  body: string;
  collection: "articlesUk";
  data: InferEntrySchema<"articlesUk">;
  render(): Render[".md"];
}>;
